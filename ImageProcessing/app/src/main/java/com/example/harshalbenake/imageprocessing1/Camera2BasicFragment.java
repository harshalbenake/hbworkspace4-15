...
/**
 * Created by harshal.benake on 20-01-2016.
 */
...
//        mFile = new File(getActivity().getExternalFilesDir(null), "pic.jpg");
        mFile = new File(Environment.getExternalStorageDirectory() + "/" + getResources().getString(R.string.app_name),
    ...
    private void scanFile() {
        try {
            ...
            Utility.writeLogIntoFile(getActivity(), recognizedText);
            baseApi.end();
        } catch (Exception e) {
            e.printStackTrace();
        }
