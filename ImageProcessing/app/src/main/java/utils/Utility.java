...
import com.example.harshalbenake.imageprocessing1.R;
...
public class Utility {
     ...
     * @param text    text
     */
    public static void writeLogIntoFile(Context context,String text) {
        try {
            System.out.println("writeLogIntoFile: "+text);
            String filePath=Environment.getExternalStorageDirectory() +"/"+context.getResources().getString(R.string.app_name);
